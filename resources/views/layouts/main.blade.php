...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyErricsson, Motorola web design" />
    ...
    <link href="{{asset('frontend/css/nav.css')}}" type="text/css" media="all"/>
    ...
    <div class="container">
        <div class="header">
            ...
            <div class="top-nav">
                ...
                <ul class="nav">
                    <li class="dropdown1"><a href="">BICYCLES</a>
                        <ul class="dropdown2"><a href="">PARTS</a>
                            <li><a href="">FIXED / SINGLE SPEED</a></li>
                            <li><a href="">CITY BIKES</a></li>
                            <li><a href="">PREMIMUN SERIES</a></li>
                        </ul>
                    </li>
                    <li class="dropdown1"><a href="">PARTS</a>
                        <ul class="dropdown2"><a href="">PARTS</a>
                            <li><a href="">CHAINS</a></li>
                            <li><a href="">TUBES</a></li>
                            <li><a href="">TIRES</a></li>
                            <li><a href="">DISC BREAKS</a></li>
                        </ul>
                    </li>
                    <li class="dropdown1"><a href="">ACCESSORIES</a>
                        <ul class="dropdown2">
                            ...
                            <li><a href="">ARM COVERS</a></li>
                            <li><a href="">JERSEYS</a></li>
                        </ul>
                    </li>
                    <li class="dropdown1"><a href="">EXTRAS</a>
                        <ul class="dropdown2">
                            <li><a href="">CLASSIC BELL</a></li>
                            <li><a href="">BOTTLE CAGE</a></li>
                            <li><a href=>TRUCK GRIP</a></li>
                        </ul>
                    </li>
                    <a class="shop" href=""><img src="{{asset('frontend/images/cart.png')}}" alt=""/></a>
                </ul>
            </div>
    ...
    <div class="caption">
        <div class="slider">
            <div class="callbacks_container">
                ...
                <a class="morebtn" href="">SHOP BIKES</a>
            </div>
        </div>
    </div>
    <div class="dwn">
        <a class="scroll" href="#cate"><img src="{{asset('frontend/images/scroll.png')}}"/></a>
    </div>
</div>
<!--/banner-->
...
<div class="bikes">
    ...
    <div class="bikes-grids">
        <ul id="flexiselDemo1">
            <li>
                <img src="{{asset('frontend/images/bik1.jpg')}}"/>
                <div class="bike-info">
                    <div class="model">
            ...
            <li>
                <img src="{{asset('frontend/images/bik2.jpg')}}" alt=""/>
                <div class="bike-info">
                    <div class="model">
            ...
            <li>
                <img src="{{asset('frontend/images/bik3.jpg')}}" alt=""/>
                <div class="bike-info">
                    <div class="model">
            ...
            <li>
                <img src="{{asset('frontend/images/bik4.jpg')}}" alt=""/>
                <div class="bike-info">
                    <div class="model">
            ...
            <li>
                <img src="{{asset('frontend/images/bik5.jpg')}}"  alt=""/>
                <div class="bike-info">
                    <div class="model">
            ...
            <li>
                <img src="{{asset('frontend/images/bik6.jpg')}}"  alt=""/>
                <div class="bike-info">
                    <div class="model">
                        <h4>SANSACHG<span>$249.00</span></h4>
                    </div>
